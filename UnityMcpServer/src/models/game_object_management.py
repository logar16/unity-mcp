...
class CreateGameObjectRequest(BaseActionRequest):
    ...
    parent: str | None = Field(
        default=None,
        description="Parent GameObject. Can be specified by name, hierarchy path, or instance ID."
    )
...
class FindGameObjectRequest(BaseActionRequest):
    ...
    search_inactive: bool | None = Field(
        default=None,
...
class ModifyGameObjectRequest(BaseActionRequest):
    ...
    target: str = Field(
        ...,
        description="Target GameObject. Can be specified by name, hierarchy path, or instance ID."
    )
    name: str | None = None
    tag: str | None = None
    layer: str | None = None
